...
namespace QLTB
{
    public partial class Form_ThietBiList : Form
    {
        ...
        private void guna2TabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (guna2TabControl1.SelectedTab == tabVeSinh)
            {
                tabVeSinh.Controls.Clear();
                UserControl_VeSinh uc = new UserControl_VeSinh();
                uc.Dock = DockStyle.Fill;
                tabVeSinh.Controls.Add(uc);
            }
        ...
        private void ApplyCustomTheme()
        {
            ...
            dgvThietBi.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(102, 126, 234);
            ...
            dgvThietBi.DefaultCellStyle.SelectionBackColor = Color.FromArgb(186, 104, 200);
            ...
            dgvThietBi.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(245, 245, 250);
        ...
        {
            guna2TabControl1.TabMenuBackColor = Color.FromArgb(102, 126, 234);
            ...
            guna2TabControl1.TabButtonHoverState.FillColor = Color.FromArgb(126, 87, 194);
            guna2TabControl1.TabButtonHoverState.ForeColor = Color.White;
            guna2TabControl1.TabButtonHoverState.Font = new Font("Segoe UI", 10, FontStyle.Bold);

            guna2TabControl1.TabButtonSelectedState.FillColor = Color.FromArgb(186, 104, 200);
